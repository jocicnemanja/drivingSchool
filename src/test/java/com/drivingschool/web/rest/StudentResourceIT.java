...
import com.drivingschool.repository.StudentRepository;
import com.drivingschool.service.dto.StudentDTO;
import com.drivingschool.service.mapper.StudentMapper;
...
class StudentResourceIT {
    ...
    void createStudent() throws Exception {
        ...
        assertThat(testStudent.getContractNumber()).isEqualTo(DEFAULT_CONTRACT_NUMBER);
        assertThat(testStudent.getPhoneNumber()).isEqualTo(DEFAULT_PHONE_NUMBER);
        assertThat(testStudent.getJmbg()).isEqualTo(DEFAULT_JMBG);
    ...
    void putExistingStudent() throws Exception {
        ...
        assertThat(testStudent.getContractNumber()).isEqualTo(UPDATED_CONTRACT_NUMBER);
        assertThat(testStudent.getPhoneNumber()).isEqualTo(UPDATED_PHONE_NUMBER);
        assertThat(testStudent.getJmbg()).isEqualTo(UPDATED_JMBG);
