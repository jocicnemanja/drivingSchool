...
describe('Exam e2e test', () => {
  ...
  describe('new Exam page', () => {
    ...
    it('should create an instance of Exam', () => {
      cy.get(`[data-cy="date"]`).type('2023-12-09T22:47');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2023-12-09T22:47');

      cy.get(`[data-cy="type"]`).type('safeguard');
      cy.get(`[data-cy="type"]`).should('have.value', 'safeguard');

      cy.get(`[data-cy="constAmount"]`).type('5874');
      cy.get(`[data-cy="constAmount"]`).should('have.value', '5874');
