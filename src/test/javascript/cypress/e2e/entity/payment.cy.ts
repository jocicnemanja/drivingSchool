...
describe('Payment e2e test', () => {
  ...
  describe('new Payment page', () => {
    ...
    it('should create an instance of Payment', () => {
      cy.get(`[data-cy="amount"]`).type('17789');
      cy.get(`[data-cy="amount"]`).should('have.value', '17789');

      cy.get(`[data-cy="date"]`).type('2023-12-09T16:38');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2023-12-09T16:38');
